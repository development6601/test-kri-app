...
import { ASSETS_API, ASSETS_IMAGE_API } from 'src/config-global';
...
export const _mock = {
  ...
  // Image
  image: {
    cover: (index: number) => `${ASSETS_IMAGE_API}/public/assets/images/mock/cover/cover-${index + 1}.webp`,
    avatar: (index: number) => `${ASSETS_IMAGE_API}/public/assets/images/mock/avatar/avatar-${index + 1}.webp`,
    travel: (index: number) => `${ASSETS_API}/public/assets/images/mock/travel/travel-${index + 1}.webp`,
    company: (index: number) => `${ASSETS_API}/assets/images/company/company_${index + 1}.png`,
    product: (index: number) => `${ASSETS_IMAGE_API}/public/assets/images/mock/m-product/product-${index + 1}.webp`,
